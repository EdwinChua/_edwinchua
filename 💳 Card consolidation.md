...
- [ ] Decide whether to convert now or after Vantage approval
...
- [ ] Enrol in Accor Plus Explorer membership
- [ ] Register Priority Pass / Digital Priority Pass
- [ ] Set up KrisFlyer auto-conversion if desired (quarterly, fee applies)
- [ ] Check KrisFlyer miles expiry dates — note oldest batch
...
- [x] Amazon prime membership (Mb F&F)
